...
Attachment1_data = DataLog('time', 'attachement2 angle')
watch = StopWatch()
for i in range(1000):
    ...
    multitask(print(time), print('|'), print(Gyro_angle), print('|'), print(Attachment1_angle), print('|'), print(Attachment2_angle))
    wait(150)